...
const SignupForm = ({ isFromAdmin = false }) => {
    ...
    <Box flex="1">
        ...
        <>
          ...
          <Box mb="20px">
            ...
            <Typography color="#888" fontSize="13px" fontWeight="bold">
              Welcome to Mashaal Market - Let's create your account
            </Typography>
          </Box>
        </>
      )}
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <Button
          ...
          disabled={loading}
        >
          {loading ? "Loading..." : isFromAdmin ? "Add User" : "Sign Up"}
        </Button>
      </form>
      ...
      {isFromAdmin ? null : (
        <Typography color="#888" fontSize="13px" mt="10px" fontWeight="bold">
          ...
          <Link to="/login" style={{ color: "#0a2914" }}>
            Log in
          </Link>
        </Typography>
      )}
